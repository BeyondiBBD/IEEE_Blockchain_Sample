...
curl -s -X POST \
  ...
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1NTE4OTI4NjAsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1NTE4NTY4NjB9.AWliiPdaZzo3uqw00-wjwpsdvACX30kszl2sCMSoGdY" \
...
```
### Join Channel request org2

```
curl -s -X POST \
  http://localhost:4000/channels/mychannel/peers \
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1NTE4OTQ3NzAsInVzZXJuYW1lIjoiRGF2ZSIsIm9yZ05hbWUiOiJPcmcyIiwiaWF0IjoxNTUxODU4NzcwfQ.W1x8guKr14184UGrcDfvHCcH3YutmsieC6aMQ3vobN4" \
  -H "content-type: application/json" \
  -d '{
...
curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"chaincodeName":"mycc",
	"chaincodePath":"/home/davor/Desktop/hyper/IEEE_Blockchain_Sample/balance-transfer/artifacts/src/github.com/example_cc/node",
	"chaincodeType": "node",
	"chaincodeVersion":"v0"
}'
```
...
```
curl -s -X GET http://localhost:4000/channels/mychannel/transactions/e2a150b59678f3e46b45c4fed32735b9cb22c72d63a22e915c84f9beacfb073e?peer=peer0.org1.example.com \
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1NTE4OTMzNjUsInVzZXJuYW1lIjoiRGF2ZSIsIm9yZ05hbWUiOiJPcmcyIiwiaWF0IjoxNTUxODU3MzY1fQ.TeMYHtffD2E36kdkFWPD_udCCRHmeKDAFMYZTW2UcA8" \
  -H "content-type: application/json"
```
